...
interface LEmptyProps {
  description?: React.ReactNode;
  style?: React.CSSProperties;
  image?: React.ReactNode;
}

export function LEmpty({ description = 'Нет данных', style, image }: LEmptyProps) {
  return (
    <div style={{ padding: '32px 0', textAlign: 'center', color: 'var(--foreground)', opacity: 0.45, ...style }}>
      {image || (
        <svg width="64" height="41" viewBox="0 0 64 41" style={{ marginBottom: 8 }}>
