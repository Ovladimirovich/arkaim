...
const MOCK_DATA: Record<string, any> = IS_DEV ? {
  ...
  '/book/world-explorer/stats': { data: { world_model: '  '/book/world-explorer/history': { data: [{ id: 1, prompt: 'Test exploration', epoch: 'satya_yuga', hypothesis_title: 'Pattern', summary: 'Test', overall_score: 0.85, branch_count_actual: 3, duration_ms: 150, created_at: new Date().toISOString() }], count: 1 },
